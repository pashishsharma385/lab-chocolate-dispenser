...
function dispenseChocolates(chocolates, number) {
    ...
    var elem = chocolates.slice((chocolates.length - number), chocolates.length);
    return elem;
}
...
function changeChocolateColorAllOfxCount(chocolates, color, newColor)
{
    ...
    let dem = [chocolates.length,chocolates];
    return dem;
}
